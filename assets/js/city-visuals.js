(function(){
  ...
  function enhance(card){
    ...
    const img=card.querySelector(':scope > img');if(img)bindFallback(img);
    const original=card.querySelector(':scope > strong');const name=original?original.textContent.trim():'City';
